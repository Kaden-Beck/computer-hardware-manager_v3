...
import { allProductsQueryOptions } from '@/queries/products';
import { allCategoriesQueryOptions } from '@/queries/categories';
import { allManufacturersQueryOptions } from '@/queries/manufacturers';
