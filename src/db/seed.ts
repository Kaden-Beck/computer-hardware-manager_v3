...
const products: ProductSeed[] = [
  ...
  // ── Cases (cat00007) ──────────────────────────────────────────────────────────
  {
    ...
    specs: {
      ...
      moboSupport: 'ATX, mATX, ITX',
      maxGPULengthMM: 381,
      maxCPUCoolerHeightMM: 165,
      maxPSULengthMM: null,
      driveSlotsTwoHalf: 2,
      driveSlotsThreeHalf: 1,
      fanSlots: 4,
      radiatorSupport: '240mm front, 120mm rear',
    },
  },
  {
    ...
    specs: {
      type: 'case',
      formFactor: 'Mid Tower',
      moboSupport: 'E-ATX, ATX, mATX, ITX',
      maxGPULengthMM: 430,
      maxCPUCoolerHeightMM: 185,
      maxPSULengthMM: null,
      driveSlotsTwoHalf: 3,
      driveSlotsThreeHalf: 2,
      fanSlots: 6,
      radiatorSupport: '360mm front, 280mm top, 140mm rear',
    },
  },
  {
  ...
  },
  {
    ...
    specs: {
      ...
      driveSlotsThreeHalf: 2,
      fanSlots: 6,
      radiatorSupport: '360mm front, 280mm top, 120mm rear',
    },
  },
  ...
  // ── Air Coolers (cat00104) ────────────────────────────────────────────────────
  {
    ...
    specs: {
      ...
      fanSizeMM: 150,
      maxTDP: 250,
      socketCompatibility: 'LGA1700, LGA1200, AM5, AM4',
      heightMM: 165,
      radiatorSizeMM: null,
    },
  },
...
async function writeBatchedAuto<T extends Record<string, unknown>>(
  collectionName: string,
  items: T[]
): Promise<void> {
  for (let i = 0; i < items.length; i += BATCH_SIZE) {
...
export async function seedDatabase(): Promise<void> {
  ...
  await writeBatchedFixed(
    'users',
    users.map(({ uuid, ...rest }) => ({ id: uuid, ...rest }))
  );
